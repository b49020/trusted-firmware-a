 ...
 * per the Nord TZ BSP (tzbsp_target.h: TZBSP_CLUSTER_COUNT=3,
 * TZBSP_NUM_OF_CORES_IN_CLUSTER_{0,1,2}=6, TZBSP_CPU_COUNT=18) and the Nord
 * device tree (three affinity-level-2 groups, cores 0..5 in each).
 */
...
/*----------------------------------------------------------------------------*/
/* UART related constants. (QUPV3_2 SE1, TZBSP_TARGET_UART_BASE_ADDR)         */
/*----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------*/
/* RNG_CM_CM_SOC_QRNG_CM (TZBSP_MMP_PRNG_BASE/LENGTH) */
 ...
 * (TZBSP_MMP_SEC_CTRL_QFPROM_RAW_BASE/LENGTH).
 */
