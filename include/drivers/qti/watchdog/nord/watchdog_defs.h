 ...
 * at 0x17820000 (tzbsp_hwio.h: APSS_WDT_SEC_WWDOG_REG_BASE =
 * SOC_CONFIG_SPACE_BASE + 0x17820000, SOC_CONFIG_SPACE_BASE = 0). This replaces
 * the legacy AOSS-block watchdog (AOSS_BASE + 0x01230000) used by the older
 * hoya SoCs.
 *
