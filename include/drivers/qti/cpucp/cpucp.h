 ...
 * SCMI Power Domain Management POWER_STATE_SET command. Mirrors the
 * downstream reference PSCI implementation's per-CPU_ON/CPU_OFF CPUCP
 * notification, which Nord's native PSCI path does not otherwise send.
 */
