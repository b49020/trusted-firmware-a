 ...
 * (SA8797P).
 *
 * Derived from the downstream ssg/cpusys/cpucp/plat/nord/include memmap:
 ...
 *                             = 0x18b33000
 * The APSS->CPUCP doorbell is the shared APSS_INTU TZ_IPC_INTERRUPT
 * register (0x17824004) - downstream cpucp_host_send_tz_ipc() writes the
 * OSM_IPC field of that same register to kick CPUCP. Confirmed via IPCAT
 ...
 * Matches downstream APSEC_CPUCP_SCMI_IPC_SIZE.
 */
