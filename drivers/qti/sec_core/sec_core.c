...
#ifdef APSS_CL_SECURE_ADDR
	mmio_write_32(APSS_CL_SECURE_ADDR, APSS_CL_SECURE_RMSK);
#endif
#ifdef APSS_ALIAS_0_CL_SECURE_ADDR
	mmio_write_32(APSS_ALIAS_0_CL_SECURE_ADDR, APSS_ALIAS_0_CL_SECURE_RMSK);
#endif
#ifdef APSS_ALIAS_1_CL_SECURE_ADDR
	mmio_write_32(APSS_ALIAS_1_CL_SECURE_ADDR, APSS_ALIAS_1_CL_SECURE_RMSK);
#endif
...
#ifdef GOLD_PLL_SECURE_ADDR
	mmio_write_32(GOLD_PLL_SECURE_ADDR, GOLD_PLL_SECURE_RMSK);
#endif
#ifdef SILVER_PLL_SECURE_ADDR
	mmio_write_32(SILVER_PLL_SECURE_ADDR, SILVER_PLL_SECURE_RMSK);
#endif
#ifdef L3_PLL_SECURE_ADDR
	mmio_write_32(L3_PLL_SECURE_ADDR, L3_PLL_SECURE_RMSK);
#endif
#ifdef CL0_GOLD_PLL_SECURE_ADDR
	mmio_write_32(CL0_GOLD_PLL_SECURE_ADDR, CL0_GOLD_PLL_SECURE_RMSK);
#endif
#ifdef CL1_GOLD_PLL_SECURE_ADDR
	mmio_write_32(CL1_GOLD_PLL_SECURE_ADDR, CL1_GOLD_PLL_SECURE_RMSK);
#endif
#ifdef CL0_L3_PLL_SECURE_ADDR
	mmio_write_32(CL0_L3_PLL_SECURE_ADDR, CL0_L3_PLL_SECURE_RMSK);
#endif
#ifdef CL1_L3_PLL_SECURE_ADDR
	mmio_write_32(CL1_L3_PLL_SECURE_ADDR, CL1_L3_PLL_SECURE_RMSK);
#endif
